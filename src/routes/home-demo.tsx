...
export const Route = createFileRoute("/home-demo")({
  head: ({ match }) =>
    createSeoHead({
      ...
      path: "/home-demo",
      image: hero,
      ogTitle: "EPOCHA Demo — The Human Premium Credential",
      socialDescription:
        "A standardized index that measures and certifies your un-automatable human capabilities.",
      noIndex: true,
    }),
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="container-x relative py-28 md:py-40 text-center">
          ...
          <h1 className="mt-4 text-4xl md:text-6xl lg:text-7xl font-bold text-white leading-[1.05] max-w-5xl mx-auto">
            ...
            <span className="text-lime">{t("irreplaceable.")}</span>
          </h1>
        ...
        <div className="container-x py-24">
          <div className="max-w-3xl">
            ...
            <h2 className="mt-3 text-4xl md:text-5xl font-bold">
              ...
              <span className="text-lime">{t("AI can't fake.")}</span>
            </h2>
            ...
            {[
              {
                ...
                letter: "E",
                title: "Build Empathy",
                desc: "Reading others' emotions and needs — the foundation of trust and collaboration.",
              },
              {
                icon: Eye,
                letter: "P",
                title: "Master Presence",
                desc: "Full engagement in the moment. Listening, noticing, and responding with intention.",
              },
              {
                icon: MessageSquare,
                letter: "O",
                title: "Judge with Conviction",
                desc: "Independent judgment and the courage to take a stand.",
              },
              {
                icon: PenTool,
                letter: "C",
                title: "Create Fearlessly",
                desc: "Original ideas that turn constraints into breakthroughs.",
              },
              {
                icon: History,
                letter: "H",
                title: "Lead with Hope",
                desc: "Forward-looking resilience that sustains effort and inspires others.",
              },
            ].map((c) => {
              const I = c.icon;
              return (
      ...
      <section className="bg-ink text-cream">
        <div className="container-x py-24">
          <div className="max-w-3xl">
            ...
            <h2 className="mt-3 text-4xl md:text-5xl font-bold">
              {t("Use AI.")} <span className="text-lime">{t("Don't fear it.")}</span>
            </h2>
            <p className="mt-5 text-cream/70">
            ...
            {[
              {
                icon: Brain,
                title: "Understand AI",
                desc: "Know where it excels and where it fails — and when to intervene.",
              },
              {
                icon: Bot,
                title: "Prompt & Steer",
                desc: "Craft clear prompts and iterate toward better outputs.",
              },
              {
                icon: Lightbulb,
                title: "Critical Judgment",
                desc: "Check AI for bias and accuracy. You stay the decision-maker.",
              },
              {
                icon: Wrench,
                title: "Workflow Integration",
                desc: "Embed AI into real work to multiply your productivity.",
              },
            ].map((c) => {
              const I = c.icon;
              return (
      ...
      <section className="bg-ink text-cream">
        <div className="container-x py-20 text-center">
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-[1.1]">
            {t("AI Literacy")} <span className="text-lime">+</span> {t("EPOCH")}{" "}
            <span className="text-lime">{t("= unstoppable.")}</span>
          </h2>
      ...
      <section className="bg-ink text-cream">
        <div className="container-x py-24">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <h2 className="mt-3 text-4xl md:text-5xl font-bold">
              {t("Find your")} <span className="text-lime">{t("path forward.")}</span>
            </h2>
            <p className="mt-5 text-cream/70">
              {t(
          ...
          <div className="mt-14 grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              {
                icon: GraduationCap,
                audience: "Youth (14–29)",
                title: "Launch your career",
                desc: "Practicums and coaching that turn potential into a verified portfolio.",
              },
              {
                icon: Briefcase,
                audience: "Job Seekers",
                title: "Re-skill & re-enter",
                desc: "Bootcamps and a verified HPI that prove you're future-ready.",
              },
              {
                icon: Building2,
                audience: "Corporates",
                title: "Develop your people",
                desc: "Upskilling and talent decisions backed by structured peer review.",
              },
              {
                icon: School,
                audience: "Schools & Universities",
                title: "Future-ready students",
                desc: "Plug our practicums and EPOCH curriculum into your programs.",
              },
            ].map((c) => {
              const I = c.icon;
              return (
        ...
        <div className="container-x py-24">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-1 lg:order-2">
              ...
              <h2 className="mt-3 text-4xl md:text-5xl font-bold">
                {t("Launch your career with")} <span className="text-lime">{t("Hanaro.")}</span>
              </h2>
              ...
              <ul className="mt-6 space-y-3">
                {[
                  ...
                  <li key={p} className="flex gap-3 text-cream/80">
                    <BadgeCheck className="w-5 h-5 text-lime shrink-0 mt-0.5" /> {t(p)}
                  </li>
                ))}
              </ul>
              <div className="mt-8">
                <Link to="/practicums/hanaro" className="btn-primary">
                  {t("Explore Hanaro Practicum")} <ArrowRight className="w-4 h-4" />
                </Link>
              </div>
            </div>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h2 className="mt-3 text-4xl md:text-6xl font-bold text-foreground leading-[1.05]">
                {t("Earn a badge")} <span className="text-lime">{t("others")}</span>{" "}
                {t("vouch for.")}
              </h2>
              ...
              <div className="mt-8 flex flex-wrap gap-4">
                <Link to="/how-hpi-works" className="btn-primary">
                  {t("See how reviews work")} <ArrowRight className="w-4 h-4" />
                </Link>
      ...
      <section className="bg-background">
        <div className="container-x py-24 text-center">
          <h2 className="text-4xl md:text-5xl font-bold text-foreground max-w-3xl mx-auto">
            {t("Ready to earn your")} <span className="text-lime">{t("Human Premium?")}</span>
          </h2>
          <div className="mt-10 flex flex-wrap gap-4 justify-center">
            <Link to="/practicums" className="btn-primary">
              {t("Explore programs")} <ArrowRight className="w-4 h-4" />
            </Link>
