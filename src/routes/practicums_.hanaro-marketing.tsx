          ...
          <div className="mt-10 grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {[
              ...
              },
              {
                ...
                desc: "Practical skills — leadership, project management, public advocacy — built through real work, not theory.",
              },
            ].map((g) => (
      ...
      <section className="bg-background text-foreground">
        <div className="container-x py-20">
          ...
          <p className="mt-4 text-foreground/80 max-w-2xl">
            A maximum of 10 participants team up to develop and lead their own project, moving
            through three structured phases with coaching and mentor support at every step.
          </p>
          ...
          <div className="mt-12 grid gap-5 lg:grid-cols-[minmax(0,1.15fr)_minmax(320px,0.85fr)]">
            <div className="rounded-lg border border-border bg-card p-6 md:p-8">
              ...
              <div className="mt-6 space-y-5">
                {[
                  {
                    week: "Weeks 1–2 · Foundation & Design",
                    title: "Foundation & Design",
                    desc: "Identify your cause, connect with an NGO or charity partner, and shape your project concept. Define goals, stakeholders, and a realistic plan for the weeks ahead.",
                    tags: ["Ideation", "Partner outreach", "Planning"],
                  },
                  {
                    week: "Weeks 3–5 · Development & Execution",
                    title: "Development & Project Execution",
                    desc: "Run your campaign or initiative, manage logistics, coordinate with your partner organisation, and adapt in real time. This is where you put leadership into practice.",
                    tags: ["Campaign execution", "Community engagement"],
                  },
                  {
                    week: "Week 6 · Closing",
                    title: "Closing & Presentation",
                    desc: "Present your project outcomes to mentors, peers, and partner organisations. Reflect on what you built, document your impact, and receive your PEN-Worldwide credentials.",
                    tags: ["Presentation", "Certification", "Reflection"],
                  },
                ].map((p) => (
                  <div
                    key={p.week}
                  ...
                  >
                    ...
                    <div className="mt-3 flex flex-wrap gap-2">
                      {p.tags.map((t) => (
                        <span
                          key={t}
                          className="inline-block text-xs px-3 py-1 rounded-full bg-[#FBE8C6] text-[#8C5A12] font-semibold"
                        >
                          {t}
                        </span>
                      ))}
            ...
            <div className="rounded-lg border border-border bg-card p-6 md:p-8">
              ...
              <p className="mt-5 text-sm text-foreground/75 leading-relaxed">
                Each day closes with a debrief: presenting the day's output, agreeing next steps,
                and reflecting on what was learned — keeping the project on track and the learning
                visible.
              </p>
            ...
            <div className="mt-14 grid lg:grid-cols-12 gap-12 items-start">
              ...
              <div className="lg:col-span-5">
                <article className="rounded-3xl border border-border bg-card text-foreground overflow-hidden flex flex-col">
                  ...
                  <div className="p-7 flex flex-col">
                    ...
                    <p className="mt-3 text-foreground/70 text-sm leading-relaxed">
                      Participants form a Practice Enterprise and collaborate to lead a brand
                      awareness campaign for a cause they care about.
                    </p>
                ...
                <div className="mt-6 rounded-2xl border border-white/15 bg-white/5 p-5">
                  <p className="text-xs uppercase font-bold tracking-wider text-[#F2C766]">
                    How to REGISTER
                  </p>
                ...
                <div className="mt-6 rounded-2xl border border-white/15 bg-white/5 p-5">
                  ...
                  <div className="mt-4 rounded-xl bg-white/5 p-4 flex items-center justify-center h-24">
                    <span className="text-xs uppercase tracking-wider text-[#F5E4C2] font-semibold">
                      Partner logo
                    </span>
                  </div>
              ...
              <div className="lg:col-span-7">
                <p className="text-lg text-[#F5E4C2]">
                  For 6 weeks in Seoul, run a brand awareness campaign and explore diverse roles
                  across the marketing and advertising industry from creative and strategic to
                ...
                <ol className="mt-8 space-y-4">
                  {[
                    ...
                    {
                      icon: Megaphone,
                      title: "Lead a brand awareness campaign",
                      desc: "Collaborate with nine other trainees to develop and execute a brand awareness campaign for an NGO partner.",
                    },
                    {
                      icon: GraduationCap,
