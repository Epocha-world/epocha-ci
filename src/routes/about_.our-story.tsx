...
import { ArrowRight, Briefcase, ExternalLink, HandHeart, Handshake, Lightbulb, Linkedin, Quote, Rocket } from "lucide-react";
...
export const Route = createFileRoute("/about_/our-story")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Meet the founders behind EPOCHA and the story of how we got started." },
      { property: "og:title", content: "Our Story — EPOCHA Learning Hub" },
      { property: "og:description", content: "Meet the founders behind EPOCHA and the story of how we got started." },
    ],
  }),
  ...
  return (
    <>
        ...
        <div className="container-x py-20 md:py-28 flex flex-col items-center text-center">
          ...
          <blockquote className="max-w-4xl">
            <p className="text-2xl md:text-4xl font-bold text-foreground leading-[1.2]">
              EPOCHA transforms how young people aged 14–29 leverage experiential learning, <span className="text-coral">turning academic effort into real career momentum.</span> We give them the hands-on experience, professional connections, and confidence to thrive from day one.
            </p>
          </blockquote>
        </div>
      </section>
        ...
        <div className="container-x py-20 grid md:grid-cols-2 gap-16">
          <div>
            ...
            <p className="mt-5 text-cream/70 leading-relaxed">
              Young talent today enters a landscape where the odds are stacked against them.
              Beyond high unemployment, many are stuck in 'gig' roles without security
              because they haven't been given the tools to prove the high-level skills employers demand.
            </p>
            <p className="mt-4 text-cream/70 leading-relaxed">
              EPOCHA exists to change that. We help international and diverse communities of
              young learners move from the challenges of entering the job market to thriving,
          ...
          <div className="grid gap-6 self-center">
            {[
              ...
              <div key={s.key} className="rounded-2xl border border-cream/15 bg-white/5 p-6 flex items-center gap-6">
                <div className="text-5xl font-display font-bold text-lime min-w-[120px]">{s.label}</div>
      ...
      <section className="border-y border-border bg-background">
        <div className="container-x py-20 grid md:grid-cols-3 gap-10">
          {[
            { icon: Lightbulb, title: "Our Approach", desc: "We reduce youth unemployment by creating project-based practicums that connect young people aged 14-29 with opportunities they need to turn learning experiences into a career portfolio." },
            { icon: Rocket, title: "What We Want", desc: "We create a unified ecosystem where students learn by doing, businesses access job-ready talent, institutions cultivate leaders, and organizations increase their impact together." },
            { icon: HandHeart, title: "Who We Work With", desc: "We partner with forward-thinking organizations across education, marketing, business, social enterprise, creative industries, sustainability and environment, cultural entertainment and tourism." },
          ].map((b) => (
            <div key={b.title}>
      ...
      <section className="bg-ink">
        <div className="container-x py-20 md:py-28">
          <div className="relative rounded-3xl bg-background border border-border p-10 md:p-16 overflow-hidden">
            <span aria-hidden className="absolute top-8 left-8 md:top-10 md:left-12 text-foreground/80 font-serif font-bold leading-none select-none text-[120px] md:text-[180px]">
              &ldquo;
            </span>
            <span aria-hidden className="absolute bottom-8 right-8 md:bottom-10 md:right-12 text-coral font-serif font-bold leading-none select-none text-[60px] md:text-[90px]">
              &rdquo;
            </span>
            <blockquote className="relative max-w-3xl mx-auto text-center pt-24 md:pt-28 pb-16 md:pb-20">
              <p className="text-xl md:text-2xl font-semibold text-foreground leading-[1.5] italic">
                "We didn't build Epocha to fix a system. <span className="text-coral not-italic">We built it for people because lost potential is humanity's greatest waste.</span> Not resources. Not time. People. People deserve better and better is still possible."
              </p>
            </blockquote>
            <p className="relative mt-2 text-center text-foreground/60 text-sm uppercase tracking-[0.2em]">The people behind the mission</p>
          </div>
        </div>
      </section>
    ...
    <section className="container-x py-24">
      <div className="max-w-2xl">
        ...
        <h1 className="mt-3 text-4xl md:text-5xl font-bold">Built on the power of <span className="text-lime">connection</span>.</h1>
        <p className="mt-4 text-foreground/70">
          Maeva and Jess founded EPOCHA on a shared conviction: that real growth happens
          when people are genuinely connected — to themselves, to each other, and to the
          work that matters. Every practicum, coaching session, and partnership we build
          is designed to turn that belief into lived experience.
        </p>
      </div>
      ...
      <div className="mt-14 grid md:grid-cols-2 gap-8">
        {[
          { name: "Maeva Ofranc", role: "Co-Founder & CEO", img: maevaPortrait, bio: "Generalist and systems thinker, Maeva designs and builds high-impact coaching and mentoring programs. She believes every young person deserves a runway, not a ladder. Rooted in Caribbean French heritage and shaped by many cultures, she brings a depth of perspective that makes her work truly borderless.", linkedin: "https://www.linkedin.com/in/maeva-ofranc-49b96b24/" },
          { name: "Jess Ng", role: "Co-Founder & CMO", img: jessPortrait, bio: "Founder of Upleash and Impact Comedy, Jess is a soft-skills coach who helps people communicate with clarity, lead with self-awareness, and build genuine connection at work. She bridges the gap between what businesses need and what young talent is ready to bring.", linkedin: "https://www.linkedin.com/in/jesschingwa/" },
        ].map((p) => (
          <div key={p.name} className="rounded-3xl border border-border bg-muted/30 p-8 flex gap-6 items-start">
            <img
              src={p.img}
            ...
            <div>
              <div className="flex items-center gap-3">
                ...
                <a href={p.linkedin} target="_blank" rel="noopener noreferrer" aria-label={`${p.name} LinkedIn`}>
      ...
      <div className="mt-20">
        <div className="flex items-center gap-3">
          ...
          <p className="text-xs uppercase tracking-[0.2em] text-foreground/60 font-bold">Other ventures</p>
        </div>
          ...
          {[
            ...
            <div key={group.founder} className="flex flex-col gap-4">
              <div className="rounded-2xl bg-ink text-cream p-5">
                <p className="text-[11px] uppercase tracking-[0.2em] text-lime font-bold">Coaching by</p>
        ...
        <div className="rounded-[2.5rem] bg-ink text-cream p-12 md:p-20 relative overflow-hidden">
          <div className="relative max-w-2xl">
            ...
            <div className="mt-8 flex flex-wrap gap-4">
              <Link to="/" hash="choose-your-practicum" className="inline-flex items-center gap-2 bg-lime text-ink font-semibold px-6 py-3.5 rounded-full hover:bg-lime/90 transition">
                Find your practicum <ArrowRight className="w-4 h-4" />
              </Link>
              <Link to="/about/partnerships" className="inline-flex items-center gap-2 border border-cream text-cream font-medium px-6 py-3.5 rounded-full hover:bg-cream hover:text-ink transition">
                For organizations
              </Link>
            </div>
          </div>
