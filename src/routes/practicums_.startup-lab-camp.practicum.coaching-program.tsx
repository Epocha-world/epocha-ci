    ...
    <>
          ...
          <div className="mt-10 grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {[
              ...
              },
              {
                icon: Network,
                title: "Network",
                desc: "Direct exposure to professionals and organisations in their field, and a peer group of motivated young entrepreneurs.",
              },
            ].map((g) => (
      ...
      <section className="border-t border-border bg-background text-foreground">
        <div className="container-x py-16">
          <h2 className="text-3xl font-bold md:text-4xl">{t("Explore capstone projects")}</h2>
          <p className="mt-5 max-w-3xl text-lg text-foreground/80">
            {t(
              "Browse the capstone projects currently open to Start-up Lab Camp trainees. Each capstone is a real-world challenge delivered in partnership with an industry partner.",
            )}
          </p>
          <Link
