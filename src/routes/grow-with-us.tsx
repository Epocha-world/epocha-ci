...
function GrowWithUsPage() {
  ...
  return (
    <>
      {/* HERO — dark */}
      <section id="epocha-x-upperclass" className="surface-inverse text-cream scroll-mt-20">
      ...
      <section className="bg-background text-foreground">
        <div className="container-x py-24">
          ...
          <h2 className="mt-3 text-3xl md:text-4xl font-bold leading-tight">
            ...
            <span className="text-brand-accent">{t("put your spin on it.")}</span>
          </h2>
          <div className="mt-10 grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {[
              ...
              <div key={item.title} className="rounded-2xl border border-border bg-muted/30 p-5">
                <div className="flex items-center justify-center w-10 h-10 rounded-full bg-lime/15 text-brand-accent">
      ...
      <section className="bg-background text-foreground">
        <div className="container-x py-24">
          <div className="rounded-3xl surface-inverse text-cream border border-lime/30 p-8 md:p-12 text-center">
            <p className="text-xs uppercase tracking-[0.2em] text-brand-accent font-bold">
              {t("Ready to start?")}
            </p>
            <h2 className="mt-3 text-3xl md:text-4xl font-bold leading-tight text-cream">
              {t("Join")} <span className="text-brand-accent">{t("hundreds")}</span>{" "}
