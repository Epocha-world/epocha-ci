      ...
      <section className="relative overflow-hidden">
        ...
        <div className="container-x relative py-28 md:py-36 text-center">
          ...
          <h1 className="mt-4 text-4xl md:text-6xl lg:text-7xl font-bold text-white leading-[1.05] max-w-5xl mx-auto">
            {t("A credential")} <span className="text-lime">{t("others vouch for.")}</span>
          </h1>
        ...
        <div className="container-x py-24">
          <div className="max-w-3xl">
            ...
            <h2 className="mt-3 text-4xl md:text-5xl font-bold">
              {t("Bet on the skills that")} <span className="text-lime">{t("don't expire.")}</span>
            </h2>
        ...
        <div className="container-x py-24 grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <h2 className="mt-3 text-4xl md:text-5xl font-bold text-foreground leading-tight">
              ...
              <span className="text-lime">{t("how others experience you.")}</span>
            </h2>
      ...
      <section className="bg-ink text-cream">
        <div className="container-x py-24">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <h2 className="mt-3 text-4xl md:text-5xl font-bold">
              {t("The five")} <span className="text-lime">{t("EPOCH dimensions.")}</span>
            </h2>
            <p className="mt-5 text-cream/70">
              {t(
        ...
        <div className="container-x py-24">
          <div className="max-w-3xl">
            ...
            <h2 className="mt-3 text-4xl md:text-5xl font-bold text-foreground">
              ...
              <span className="text-lime">{t("peer-verified badge.")}</span>
            </h2>
          </div>
      ...
      <section className="bg-gradient-to-br from-lime/10 via-background to-coral/10">
        <div className="container-x py-24 grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <h2 className="mt-3 text-4xl md:text-5xl font-bold text-foreground leading-tight">
              {t("From")} <span className="text-lime">{t("real reviews")}</span>{" "}
            ...
            <ul className="mt-6 space-y-3 text-muted-foreground">
              <li className="flex gap-3">
                <Sparkles className="w-5 h-5 text-lime shrink-0 mt-0.5" />{" "}
          ...
          <div className="rounded-3xl border border-border bg-card p-8 shadow-2xl">
            ...
            <div className="mt-8 text-center">
              ...
              <p className="mt-2 text-sm text-lime font-bold">{t("Top 12% globally")}</p>
            </div>
        ...
        <div className="container-x py-24">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <h2 className="mt-3 text-4xl md:text-5xl font-bold text-foreground">
              ...
              <span className="text-lime">{t("every stakeholder.")}</span>
            </h2>
          </div>
          <div className="mt-14 grid md:grid-cols-3 gap-6">
            {[
        ...
        <div className="container-x py-24">
          <div className="max-w-3xl mx-auto">
            ...
            <h2 className="mt-3 text-4xl md:text-5xl font-bold text-center">
              {t("Good to")} <span className="text-lime">{t("know.")}</span>
            </h2>
            <div className="mt-12 space-y-6">
              {[
                ...
                <div key={f.q} className="rounded-2xl border border-cream/15 bg-white/5 p-6">
                  <h3 className="text-lg font-bold text-cream">{t(f.q)}</h3>
        ...
        <div className="container-x py-24 text-center">
          ...
          <div className="mt-10 flex flex-wrap gap-4 justify-center">
            <Link to="/hpi-assessment" className="btn-primary">
              {t("Begin your HPI assessment")} <ArrowRight className="w-4 h-4" />
            </Link>
