      ...
      <div className="grid lg:grid-cols-5 gap-10">
        <div className="lg:col-span-2 space-y-8">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 rounded-full bg-lime text-ink font-semibold px-5 py-2.5 hover:opacity-90 transition"
          >
        ...
        >
          ...
          <label className="block">
            ...
            <select className="mt-2 w-full bg-input/40 border border-border rounded-xl px-4 py-3 focus:border-lime outline-none">
              ...
              <option>Hanaro Leadership Practicum</option>
              <option>Mirae Industry Practicum</option>
              <option>Start-up Lab Camp</option>
