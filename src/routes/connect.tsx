...
function ConnectPage() {
  const { t } = useI18n();
  return (
    <section className="surface-light container-x pt-20 pb-24 ">
      <div className="grid lg:grid-cols-5 gap-10">
        <div className="lg:col-span-2 space-y-8">
          <div>
            <p aria-hidden="true" className="text-xs uppercase tracking-[0.2em] text-coral" />
            <h1 className="mt-4 text-5xl md:text-7xl font-bold max-w-3xl leading-[1] text-black">
              {t("Let's")} <span className="text-black">{t("talk.")}</span>
            </h1>
          ...
          <div className="flex gap-4">
            <Mail style={{ color: "#000" }} className="w-6 h-6 text-black shrink-0 mt-1" />
            <div>
          ...
          <div className="flex gap-4">
            <MapPin style={{ color: "#000" }} className="w-6 h-6 text-black shrink-0 mt-1" />
            <div>
              <p className="text-sm uppercase tracking-widest text-muted-foreground">
                {t("Office")}
              </p>
          ...
          <div className="flex gap-4">
            <Clock style={{ color: "#000" }} className="w-6 h-6 text-black shrink-0 mt-1" />
            <div>
              <p className="text-sm uppercase tracking-widest text-muted-foreground">
                {t("Office hours")}
              </p>
        ...
        <aside className="self-start rounded-3xl border border-border bg-card p-8 lg:col-span-3">
          ...
          <h2 className="mt-10 text-xs uppercase tracking-[0.2em] text-muted-foreground">
            {t("Chat with us")}
          </h2>
          <div className="flex flex-col items-start gap-3 mt-5">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 rounded-full border border-lime bg-transparent px-5 py-2.5 font-semibold text-black transition-colors hover:bg-lime hover:text-black focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-lime"
            >
              <FileText style={{ color: "#000" }} aria-hidden="true" className="h-5 w-5" />
              {t("Leave us a note")}
            </a>
            <a
