      ...
      <div className="grid lg:grid-cols-5 gap-10">
        <div className="lg:col-span-3 space-y-8">
          ...
          <div className="flex gap-4">
            ...
            <div>
              ...
              <a
                ...
                className="mt-1 block text-lg hover:text-brand-accent"
              >
                {t("hello@epocha.world")}
              </a>
            </div>
          </div>
          <div className="flex gap-4">
            ...
            <div>
              ...
              <p className="mt-1 text-lg leading-relaxed">
                {t("R214, 2nd Floor")}
                <br />
                {t("10 Yeonmujang 11-gil, Seongdong-gu")}
                <br />
                {t("Seoul, South Korea")}
              </p>
            </div>
          ...
          <div className="flex gap-4">
            ...
            <div>
              <p className="text-sm uppercase tracking-widest text-muted-foreground">
                {t("Office hours · Seoul (KST)")}
              </p>
              <p className="mt-1 text-lg leading-relaxed">
                {t("Mon–Fri · 9:00 – 18:00")}
                <br />
                {t("Sat · 9:00 – 12:00 (by appointment)")}
              </p>
            </div>
          </div>
          <div className="flex flex-col items-start gap-3">
            <a
              ...
              className="inline-flex items-center gap-2 rounded-full border border-lime bg-transparent px-5 py-2.5 font-semibold text-brand-accent transition-colors hover:bg-lime hover:text-ink focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-lime"
            >
              <FileText aria-hidden="true" className="h-5 w-5" />
              {t("Leave us a note")}
            </a>
            <p className="text-xs text-muted-foreground">{t("External form · English")}</p>
            <a
        ...
        <aside className="self-start rounded-3xl border border-border bg-card p-8 lg:col-span-2 lg:sticky lg:top-28">
          ...
          <div className="mt-5 space-y-3">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group flex w-full items-center gap-3 rounded-full border border-border px-5 py-4 font-semibold transition-colors hover:border-lime hover:text-brand-accent focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-lime"
            >
              <Instagram aria-hidden="true" className="h-5 w-5 text-brand-accent" />
              {t("Instagram")}
            </a>
            <a
              ...
              className="group flex w-full items-center gap-3 rounded-full border border-border px-5 py-4 font-semibold transition-colors hover:border-lime hover:text-brand-accent focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-lime"
            >
              <Linkedin aria-hidden="true" className="h-5 w-5 text-brand-accent" />
              {t("LinkedIn")}
            </a>
          </div>
        </aside>
