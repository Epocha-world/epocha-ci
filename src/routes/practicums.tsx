...
import stockPhoto2 from "@/assets/stock-photos/Images/Stock photo 2.jpg";
import stockPhoto3 from "@/assets/stock-photos/Images/Stock photo 3.jpg";
import stockPhoto4 from "@/assets/stock-photos/Images/Stock photo 4.jpg";
import stockPhoto5 from "@/assets/stock-photos/Images/Stock photo 5.jpg";
...
export const Route = createFileRoute("/practicums")({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: stockPhoto2 },
    ],
  }),
    ...
    <>
      <section className="container-x pt-20 pb-16 grid lg:grid-cols-12 gap-12 items-center">
        <div className="lg:col-span-7">
          <p className="text-xs uppercase tracking-[0.2em] text-coral">YOUR PRACTICUM</p>
      ...
      <section className="container-x py-20">
        ...
        <div className="mt-12 grid md:grid-cols-3 gap-6">
          {[
            {
              age: "14–18",
              title: "International Youth Leadership Camp",
              desc: "An immersive launchpad for emerging leaders to build confidence, voice, and cross-cultural fluency.",
            },
            {
              age: "19–29",
              title: "EPOCHA Practicums & Youth Advisory Board",
              desc: "Lead real projects, simulate business operations, and shape the EPOCHA experience for future cohorts.",
            },
            {
              age: "19–24",
              title: "Hanaro Emerging Leadership Practicum",
              desc: "A signature program for early-career professionals to develop strategic leadership through industry projects.",
            },
          ].map((p, i) => (
            <article
              key={p.title}
            ...
            >
              <div className="aspect-[4/3] overflow-hidden">
                <img
                  src={i === 0 ? stockPhoto3 : i === 1 ? stockPhoto4 : stockPhoto5}
                  alt=""
                  width={1400}
                  height={1000}
                  loading="lazy"
              ...
              <div className="p-7 flex-1 flex flex-col">
                ...
                <p className="mt-5 text-sm text-coral">{i === 0 ? "Closed" : "2026 Intake →"}</p>
              </div>
            </article>
          ))}
        </div>
      ...
      <section className="border-y border-border bg-secondary/30">
        <div className="container-x py-20">
          ...
          <h2 className="mt-3 text-4xl md:text-5xl font-bold">
            Not all experience is <span className="text-lime">created equal.</span>
          </h2>
