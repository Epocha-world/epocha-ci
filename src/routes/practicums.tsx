...
const AMBER = "var(--color-brand-accent)";
...
function Pill({ children }: { children: React.ReactNode }) {
  return (
    <span className="inline-flex items-center text-xs px-3 py-1.5 rounded-full bg-muted/60 border border-border text-foreground/80">
      {children}
    </span>
  );
}
...
function TrainingPage() {
  ...
  return (
    <>
      ...
      <section className="bg-muted/40 text-foreground border-t border-border">
        <div className="container-x py-24 md:py-28">
          ...
          <h2 className="mt-3 text-4xl md:text-5xl font-bold leading-[1.05]">
            {t("Gen Z challenges are real. So is our response.")}
          </h2>
          ...
          <Tabs defaultValue="t1" className="mt-12 w-full">
            <TabsList className="grid h-auto w-full grid-cols-1 gap-2 rounded-xl border border-border bg-background/60 p-2 md:grid-cols-3">
              <TabsTrigger
                value="t1"
                className="min-h-14 w-full border border-transparent px-4 py-3 text-center text-sm font-semibold text-foreground/75 md:text-base data-[state=active]:border-primary data-[state=active]:bg-primary data-[state=active]:text-primary-foreground data-[state=active]:shadow-md data-[state=active]:ring-2 data-[state=active]:ring-[#2A1B08]/10"
              >
      ...
      {/* 1c. QUOTE */}
      <section className="surface-inverse text-foreground border-t border-border/10">
        <div className="container-x py-16 md:py-20">
          <h2 className="text-center text-4xl md:text-5xl font-bold leading-[1.05]">
            {t("Boosting your employability.")}
          </h2>
          <blockquote className="max-w-4xl mx-auto text-center">
            <p className="mt-8 text-2xl md:text-3xl font-semibold italic leading-snug text-foreground/90">
              {t(
      ...
      <section id="training-concept" className="bg-background text-foreground scroll-mt-28">
        <div className="container-x py-24 md:py-28">
          ...
          <p className="mt-6 text-lg text-foreground/75 max-w-3xl leading-relaxed">
            {t(
              "At the heart of every EPOCHA practicum is the Practice Enterprise — an internationally proven, award-winning training model where you don't just learn about work. You do it.",
            )}
          </p>
      ...
      <section className="surface-inverse text-foreground border-t border-border/10">
        <div className="container-x py-24 md:py-28">
          ...
          <div className="relative" aria-hidden="true">
            {Object.keys(learningTabByHash).map((hash) => (
              <span key={hash} id={hash.slice(1)} className="absolute -top-28" />
            ))}
          </div>
          <Tabs value={learningTab} onValueChange={setLearningTab} className="mt-10 w-full">
            <TabsList className="grid h-auto w-full grid-cols-1 gap-2 rounded-xl border border-border/10 bg-card/10 p-2 md:grid-cols-3">
              <TabsTrigger
                value="le1"
                className="min-h-14 w-full border border-transparent px-4 py-3 text-center text-sm font-semibold text-foreground/75 md:text-base data-[state=active]:border-primary data-[state=active]:bg-primary data-[state=active]:text-primary-foreground data-[state=active]:shadow-md data-[state=active]:ring-2 data-[state=active]:ring-white/20"
              >
            ...
            <TabsContent value="le2" className="mt-8">
              ...
              <div className="mt-8 rounded-2xl border border-border/10 bg-card/10 p-6">
                <p
